...
| Codeforces | $\color{green}{1400}$ | [Codeforces1628AC](https://www.luogu.com.cn/problem/CF1628A) | mex函数 + 双指针 | 当剩余数组冲的cnt[mex] == 0时则切分数组， 三重循环但是O(n)时间复杂度 | [answer](../math/CF1628A.md) |
