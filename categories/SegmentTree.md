...
| kuangbin | $\color{green}{简单}$ | [分配任务](https://www.acwing.com/problem/content/4349/) | 线段树 + dfn序 |  对树上每个节点的时间戳建立线段树，节点及其子树的时间戳在连续区间内 | [answer](../data_structure/SegmentTree/HDU3974.md) |
| kuangbin | $\color{green}{简单}$ | [转换](https://www.acwing.com/problem/content/description/4350/) | 线段树 + 乘法/加法懒标记 |  乘法加法懒标记考虑优先级，按照 a*mul + add形式维护 | [answer](../data_structure/SegmentTree/HDU4578.md) |
