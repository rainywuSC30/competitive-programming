...
| 洛谷 | $\color{purple}{省选/NOI−}$ | [差异](https://www.luogu.com.cn/problem/P4248) | 后缀数组 + 单调栈 | 后缀数组得到height数组，后缀对集合求和对应到rank空间求和，单调栈维护height数组区间最小值，计算贡献 | [answer](../string/P4248.md) |
| kuangbin | $\color{yellow}{中等}$ | [音乐主题](https://www.acwing.com/problem/content/description/1405/) | 差分 + 二分 + 后缀数组 | 差分数组计算height和sa | [answer](../string/POJ1743.md) |
